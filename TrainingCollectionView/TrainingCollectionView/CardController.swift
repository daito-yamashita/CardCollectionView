...
class CardController {
    ...
    func generateCollections() {
        _collections = [
            ...
            Card(cost: "1", name: "test5", effect: "test5 effect", attack: nil, defense: nil, type: CardType.spell),
            ...
            Card(cost: "2", name: "test9", effect: "test9 effect", attack: nil, defense: nil, type: CardType.spell),
            Card(cost: "2", name: "test10", effect: "test10 effect", attack: nil, defense: nil, type: CardType.spell),
            ...
            Card(cost: "3", name: "test13", effect: "test13 effect", attack: nil, defense: nil, type: CardType.spell),
            
            Card(cost: "4", name: "test14", effect: "test14 effect", attack: "3", defense: "6", type: CardType.monster),
            Card(cost: "4", name: "test15", effect: "test15 effect", attack: nil, defense: nil, type: CardType.spell),
            Card(cost: "4", name: "test16", effect: "test16 effect", attack: nil, defense: nil, type: CardType.spell),
            
            Card(cost: "5", name: "test17", effect: "test17 effect", attack: nil, defense: nil, type: CardType.spell),
            Card(cost: "5", name: "test18", effect: "test18 effect", attack: nil, defense: nil, type: CardType.spell),
